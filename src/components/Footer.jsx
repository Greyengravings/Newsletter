  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {/* --- This is the footer's Emial Subscription Section --- */}
        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
            Subscribe to the Blog
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">
            Receive notifications for new blog posts and updates directly in your inbox.
          </p>
          <form onSubmit={handleSubscribe} className="mt-8 sm:flex justify-center">
            <div className="min-w-0 flex-1">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="block w-full px-5 py-3 border-0 rounded-md bg-gray-800 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500"
            ...
            <div className="mt-3 sm:mt-0 sm:ml-3">
              <button
                type="submit"
                className="block w-full py-3 px-5 rounded-md shadow bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 font-semibold transition-colors duration-300"
              >
                Subscribe
              </button>
            </div>
        ...
        {/* --- Ye Icons , Unke SVG , Path etc hai  --- */}
        {/* --- Ye LinkedIn  --- */}
        <ul className="flex justify-center space-x-4 mb-8 items-center">
        ...
        {/* --- Ye Instagram (NOTE:- (Iska color gradient abhtak properly set nahi hai) ) --- */}
...
+              </defs>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-gray-500 text-center md:text-left">
            &copy; {new Date().getFullYear()} The Digital Canvas Blog. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <a href="mailto:nihalanihitesh13@gmail.com" className="border-2 border-gray-600 text-gray-400 px-4 py-2 rounded-lg hover:bg-gray-700 hover:text-white transition-all duration-300 font-semibold">
              Contact Me
            </a>
          </div>
        </div>
